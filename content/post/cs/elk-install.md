...
[https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-6.3.1.rpm](https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-6.3.1.rpm)
...
download from [https://artifacts.elastic.co/downloads/elasticsearch-plugins/ingest-geoip/ingest-geoip-6.3.1.zip](https://artifacts.elastic.co/downloads/elasticsearch-plugins/ingest-geoip/ingest-geoip-6.3.1.zip)
...
check if kibana works [http://kibana-ip:5601](http://kibana-ip:5601)
