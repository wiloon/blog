...
lastmod: 2026-05-11T16:55:00+08:00
...
`WebSecurityConfigurerAdapter` 在 Spring Security 5.7（Boot 2.7）时已标记为 deprecated，Boot 3.x 中**完全删除**。必须改为注册 `SecurityFilterChain` Bean：
