...
| Spring 2.0（2006） | 要求 Java 5；`@Transactional`、`@Required` 等 |
| Spring 2.5（2007） | `@Autowired`、`@Component` / `@Service`、`@Controller`、`@RequestMapping` 等 |
| Spring 3.0+ | `@Configuration` + `@Bean`（Java Config），XML 进一步减少 |
