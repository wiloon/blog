...
| 2004-02 | J2SE 1.5 Beta | Tiger 公开 Beta（泛型、注解等）；早于 GA |
| 2004-09 | **Java 5** | 泛型、enum、for-each、注解、JUC → [JDK 5](./jdk-5.md) |
...
| 2026-06-24 | 发布简史补充 J2SE 1.5 Beta（2004-02）；Java 5 行注明注解 | 与 jdk-5.md Tiger 时间线对齐 |
