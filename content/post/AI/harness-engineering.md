...
与 ADR 的区别：ADR 记录「已做的决策」，Task Spec 描述「待完成的任务」。两者的详细区别、使用场景与领域来源，见 [ADR vs Task Spec：工程文档怎么分工](./adr-vs-task-spec.md)。
...
| 时间 | 修改内容 | 原因 |
| ---- | ---- | ---- |
| 2026-06-28 | Task Specs 小节补充指向 [ADR vs Task Spec](./adr-vs-task-spec.md) 的链接 | 新增专文后建立交叉引用 |
