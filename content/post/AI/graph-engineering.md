...
lastmod: 2026-07-28T14:16:15+08:00
...
## 只用 Claude Code、不接 LangGraph 时怎么办

有时候不想额外起一个 Python 主控进程，只想在 Claude Code 里把一段有依赖关系的多阶段任务当图来管。这时能落地到两种深度，选哪种取决于要不要付节点隔离和显式状态的成本。
