...
比如在一台远程主机上运行着 Grafana: 192.168.50.100:32178, 但是 192.168.50.100 只对 192.168.50.50 开放了 22 端口, 
我想从 192.168.50.50 访问 192.168.50.100 的 Grafana 就可以用 ssh 的端口转发
...
# 192.168.50.100 -l user0, ssh 连接的主机和用户名, 这里用了默认的 ssh 22 端口
