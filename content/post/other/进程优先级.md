...
需要大家注意的是，我在这里都在使用nice值这一称谓，而非优先级priority这个说法。当然，nice和renice的man手册中，也说的是priority这个概念，但是要强调一下，请大家真的不要混淆了系统中的这两个概念，一个是nice值，一个是priority值，他们有着千丝万缕的关系，但对于当前的Linux系统来说，它们并不是同一个概念。
...
测试发现java的线程优先级跟LWP的 优先级和nice值 并没有关系.  
...
[https://linux.cn/article-7325-1.html](https://linux.cn/article-7325-1.html)  
[https://linux.cn/article-7325-1.html](https://linux.cn/article-7325-1.html)  
