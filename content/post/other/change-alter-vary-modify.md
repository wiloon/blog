...
是通用词,它有两层基本含义: "变"和"换"."变"可以指和原来的样子或性质稍有不同,也可以指有本质的差异。
...
语气比 change 正式、温和，通常指部分改变，但保留原有核心。

含义：对细节或外观做修改；更偏“调整”或“修正”。

常用于：衣服尺寸、计划细节、文件内容、行为习惯等。
...
强调“多样性”或“不同版本之间的变化”，常用于一系列变化或对比。

含义：在一定范围内变动或呈现多种形式。

常用于：数据、观点、条件、程度、口味等。

主语常为事物，表示不是人为修改，而是自然存在的差异或变化。

例句：

The prices vary depending on the season.（价格根据季节而有所不同。）

The results varied from person to person.（结果因人而异。）
