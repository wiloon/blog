...
<span style="font-size: medium;">对象的适配器模式

<span style="font-family: 宋体;">在类的适配器模式中Adapter采用继承的方式复用Adaptee<span style="font-family: 宋体;">的接口，而在对象的适配器模式中Adapter则采用组合的方式实现Adaptee<span style="font-family: 宋体;">的复用
...
<span style="font-size: medium;"> * 目标角色, 相当于我们的应用程序, sampleOperation1是我们开放给客户的接口
...
<span style="font-size: medium;"> * 源角色,相当于第三方库
...
<span style="font-size: medium;"> * 适配器角色

<span style="font-size: medium;"> * 把第三方库的接口sampleOperation2转化为我们开放给客户的接口sampleOperation1
...
<span style="font-size: medium;"> * 客户端类
