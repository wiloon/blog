...
<div id="lemmaContent-0">
  ...
  <p>
    <strong>UNIX 操作系统的诞生 </strong>肯·汤普逊（左）和丹尼斯·里奇（右）<strong>
 ...
 开发者: Linux Mint Team
  ...
  <p>
    <strong>锐意的Fedora </strong><strong>
 </strong>初始版本： 2003年11月6日
  </p>
 ...
 openSUSE 项目是由 Novell 发起的开源社区计划。 旨在推进 Linux 的广泛使用。openSUSEorg提供了自由简单的方法来获得世界上最好用的 Linux 发行版，SUSELinux。 openSUSE 项目为 Linux开发者和爱好者提供了开始使用 Linux 所需要的一切。
  ...
  <p>
    <strong>自由的Debian </strong><strong>
 </strong>初始版本： 1993年8月16日
  </p>
