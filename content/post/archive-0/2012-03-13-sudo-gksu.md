...
Here’s a little known tip, if you run just “gksu” you will get a root run dialog, to run any app as root or other user.
  ...
  1. In Ubuntu (I suppose in most unix/linux systems), there is a user called root (also called superuser) that has the necessary rights (privileges) to do anything that he wants.</p> 
