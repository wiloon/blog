...
<pre><code class="language-bash line-numbers"># 批量替换目录下所有文件
...
<pre><code class="language-shell line-numbers">cat *.csv &gt;out
sed -e 's/^M//g' out &gt; foo
...
<iframe title="《sed 简明教程》—酷 壳 - CoolShell" class="wp-embedded-content" sandbox="allow-scripts" security="restricted" style="position: absolute; clip: rect(1px, 1px, 1px, 1px);" src="https://coolshell.cn/articles/9104.html/embed#?secret=6JIFuxVo3p" data-secret="6JIFuxVo3p" width="600" height="338" frameborder="0" marginwidth="0" marginheight="0" scrolling="no"></iframe>
...
<iframe title="《linux下在某行的前一行或后一行添加内容》—运维之路" class="wp-embedded-content" sandbox="allow-scripts" security="restricted" style="position: absolute; clip: rect(1px, 1px, 1px, 1px);" src="http://www.361way.com/sed-process-lines/2263.html/embed#?secret=0mIvKAwlT1" data-secret="0mIvKAwlT1" width="600" height="338" frameborder="0" marginwidth="0" marginheight="0" scrolling="no"></iframe>
