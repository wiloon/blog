...
<div id="content">
  ...
  <p>
    (4) UDP包的输出信息<br /> 用TCPDUMP捕获的UDP包的一般输出信息是：<br /> route.port1 > ice.port2: udp lenth<br /> UDP十分简单，上面的输出行表明从主机ROUTE的port1端口发出的一个UDP数据包到主机ICE的port2端口，类型是UDP， 包的长度是lenth
  </p>
