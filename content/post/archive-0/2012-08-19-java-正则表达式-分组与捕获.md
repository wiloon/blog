...
---
<pre><code class="language-java line-numbers">&lt;br />import java.util.*;
...
举例：替换掉html标签中的属性。<textareaid=&#8221;result&#8221;rows=&#8221;10&#8243;cols=&#8221;100&#8243;></textarea><scripttype=&#8221;text/javascript&#8221;>var data =&#8221;</p> <table id=\"test\"> <tr class=\"light\"> 
...
<div id="article_content">
  ...
  <p>
    一般来说要如果是要对一个字符组合采用否定判定时一般都会用上先行断言和后发断言。例如左边不能包含1302和1301的字符串，因为你没法使用某种方式来否定一个1302四个字符的组合(注意：[^（1302)|(1301)]表示不能是1或者3或者0或者2，而不是1302一个整体)，只有先行或者后发断言可以表示一个整体 : 456(?<!1302|1301)789. <strong>举例：</strong>
  </p>
