...
ADD [COLUMN] column\_definition [FIRST | AFTER col\_name ]

| ADD \[COLUMN\] (column_definition,…)

| ADD INDEX (index\_col\_name,…)
...
UNIQUE (index\_col\_name,…)

| ADD (index\_col\_name,…)

| ADD [CONSTRAINT [symbol]]

FOREIGN KEY (index\_col\_name,…)

[reference_definition]

| ALTER [COLUMN] col_name {SET DEFAULT literal | DROP DEFAULT}

| CHANGE [COLUMN] old\_col\_name column_definition

[FIRST|AFTER col_name]

| MODIFY [COLUMN] column\_definition [FIRST | AFTER col\_name]
