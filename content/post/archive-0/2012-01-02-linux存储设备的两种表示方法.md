...
---
 ...
 <span style="font-size: small;"><code>[root@localhost ~]# fdisk -l
...
/dev/hda9              22G  3.9G   18G  18% /opt/data</code><span style="font-size: small;"> 注意：挂载得需要内核支持，另外分区也得建立文件系统，请参考相关文档 ；
 ...
 <span style="font-size: small;"><code>[root@localhost ~]# grub  注：运行GRUB；
...
Done.
grub>quit 注：退出GRUB命令行模式；</code><span style="font-size: small;">
