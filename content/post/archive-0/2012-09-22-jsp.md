...
<span class="sc2">&lt;%@ page isThreadSafe<span class="sy0">=</span>true %&gt;</span> //example for a thread safe JSP线程安全JSP样例
    ...
    <div class="mw-geshi mw-code mw-content-ltr" dir="ltr">
      <div class="html4strict source-html4strict">
        <pre class="de1"><span class="sc2">&lt;%@ taglib prefix<span class="sy0">=</span><span class="st0">"myprefix"</span> uri<span class="sy0">=</span><span class="st0">"taglib/mytag.tld"</span> %&gt;</span>
