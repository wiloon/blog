...
### <span id="JSP.E6.8C.87.E4.BB.A4" class="mw-headline">JSP指令
...
<div class="mw-geshi mw-code mw-content-ltr" dir="ltr">
  <div class="html4strict source-html4strict">
    <pre class="de1"><span class="sc2"><%@ include file<span class="sy0">=<span class="st0">"somefile.jsp" %>
    ...
    <div class="mw-geshi mw-code mw-content-ltr" dir="ltr">
      <div class="html4strict source-html4strict">
        <pre class="de1"><span class="sc2"><%@ page import<span class="sy0">=<span class="st0">"java.util.*" %> //example import导入样例
<span class="sc2"><%@ page contentType<span class="sy0">=<span class="st0">"text/html" %> //example contentType页面类型样例
<span class="sc2"><%@ page isErrorPage<span class="sy0">=false %> //example for non error page无错页面样例
<span class="sc2"><%@ page isThreadSafe<span class="sy0">=true %> //example for a thread safe JSP线程安全JSP样例
    ...
    <div class="mw-geshi mw-code mw-content-ltr" dir="ltr">
      <div class="html4strict source-html4strict">
        <pre class="de1"><span class="sc2"><%@ taglib prefix<span class="sy0">=<span class="st0">"myprefix" uri<span class="sy0">=<span class="st0">"taglib/mytag.tld" %>
