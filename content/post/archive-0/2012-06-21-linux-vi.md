...
author: wiloon
type: post
date: 2012-06-21T04:20:00+00:00
url: /?p=3560
categories:
  - Linux
...
<pre><code class="language-bash line-numbers">:s/vivian/sky/g
...
:map key command\_seq 定义一个键来运行command\_seq，如:map e ea，无论什么时候都可以e移到一个字的末尾来追加文本
