...
<div class="postBody">
  <div id="cnblogs_post_body">
    ...
    <p>
      <a href="http://program-think.blogspot.com/2009/03/java-performance-tuning-1-two-types.html" target="_blank">http://program-think.blogspot.com/2009/03/java-performance-tuning-1-two-types.html</a>
    </p>
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    <td>
      <pre>int i = 5;                       // 原始类型
Integer j = new Integer(10);     // 对象引用</pre>
    </td>
  </tr>
</table>
...
y is java.awt.Point[x=5,y=5]</pre>
    </td>
  </tr>
</table>