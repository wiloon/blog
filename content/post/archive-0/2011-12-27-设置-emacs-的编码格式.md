...
<div>
  ...
  <p>
    [lisp]<br /> ;;set the default text coding system<br /> (setq default-buffer-file-coding-system &#8216;utf-8)<br /> [/lisp]<br /> 可是即使我加了上面这条语句，为什么 Emacs 依然显示 org 文件为乱码呢？
  </p>
  ...
  <pre style="text-align: left;">(prefer-coding-system 'utf-8)</pre>
