...
<span style="font-size: 14px; line-height: 1.5em;">3，然后在web.xml配置过滤器。
...
## <span style="font-size: 14px; line-height: 1.5em;">Filter 技术是Servlet 2.3 新增加的功能. 
...
<span style="line-height: 1.5em;">1.2 Servlet过滤器的基本原理
