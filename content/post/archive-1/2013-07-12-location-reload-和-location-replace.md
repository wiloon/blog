...
<span style="font-family: Verdana, Arial, Helvetica, sans-serif;"><span style="color: #0000ff;"><strong>reload</strong></span> 方法，该方法强迫浏览器刷新当前页面。</span><span style="font-family: Verdana, Arial, Helvetica, sans-serif;">
...
<span style="font-family: Verdana, Arial, Helvetica, sans-serif;"><span style="color: #0000ff;"><strong>replace</strong></span> 方法，该方法通过指定<em>URL</em>替换当前缓存在历史里（客户端）的项目，因此当使用replace方法之后，你不能通过“前进”和“后退”来访问已经被替换的<em>URL</em>。
