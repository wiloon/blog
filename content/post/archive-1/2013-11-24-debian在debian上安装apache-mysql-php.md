...
<pre># /usr/bin/mysqladmin -u root password 'enter-your-good-new-password-here'</pre>

为了安全起见，你应该不使用root账户来运行数据库，而是新建一个账户来从一个PHP脚本来连接你的mysql数据库。

  * apache2

<pre># aptitude install apache2 apache2-doc</pre>

  * PHP

<pre># aptitude install php5 php5-mysql libapache2-mod-php5</pre>
...
<pre># nano /var/www/apache2-default/test.php</pre>

插入下面代码

<pre>&lt;?php phpinfo(); ?&gt;

http://www.zzbaike.com/wiki/Debian/%E5%9C%A8Debian%E4%B8%8A%E5%AE%89%E8%A3%85Apache_Mysql_PHP</pre>