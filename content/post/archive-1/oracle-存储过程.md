...
create or replace procedure sp_test(cur_arg out sys_refcursor
...
select serv_id, serv_name from itmis_pri_serv_tbl where year = 2013;
...
Note: 在SQL*PLUS环境中设定如下命令:  SQLPLUS> set serveroutput on才能看到DBMS_OUTPUT.PUT_LINE的输出
