...
<div id="blog_content" class="blog_content">
 ...
 INFORMATION_SCHEMA.TRIGGERS  &#8211;触发器信息
    ...
    <p>
      <strong>2、显示当前连接的数据库</strong>
 mysql>select database();
    </p>
    
    <p>
      <strong>3、显示库中的数据表：</strong>
 mysql>use mysql；(指定mysql库)
 mysql>show tables;
    </p>
    
    <p>
      <strong>4、显示数据表的结构：</strong>
