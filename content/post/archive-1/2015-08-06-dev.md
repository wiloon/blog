...
[键值存储] as kv
storage--kv
[服务治理] as SOA_governance
[dubbo]
SOA_governance--dubbo
[注册中心] as register
SOA_governance--register
[熔断] as fuse
SOA_governance--fuse
[限流] as limiting
SOA_governance--limiting
[降级] as downgrade
SOA_governance--downgrade
[Kubernetes] as k8s
[docker]
k8s--docker
[Kafka] as kafka
...
[apisix]
api_gateway--apisix
[流量管理] as data_management
dubbo--data_management
[CORS] as cors
dubbo--cors
[授权和访问控制] as auth_ctrl
dubbo--auth_ctrl
[监控] as monitor
dubbo--monitor
...
[协议转换] as protocol_convert
dubbo--protocol_convert
[http2]
http--http2
[重试] as retry
pixiu--retry
...
[B+ 树] as bp
tree--bp
[Service Mesh] as service_mesh
[Istio] as istio
service_mesh--istio
data_management--istio
[Linkerd] as linkerd
