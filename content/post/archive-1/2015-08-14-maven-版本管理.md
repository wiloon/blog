...
<div id="blog_content" class="blog_content">
  ...
  <p>
    <strong>svn import -m &#8216;project initialization&#8217; https://192.168.1.100:8443/svn/myapp/trunk</strong><br /> （注意，这么做你会将目录下所有文件导入到svn库中，但是这其中某些目录和文件是不应该被导入的，如/target目录，以及eclipse相关的项目文件）
  </p>
  ...
  <div id="" class="dp-highlighter">
    <div class="bar">
      <div class="tools">
        <p>
          [xml]<br /> <scm><br /> <connection>scm:svn:http://192.168.1.100:8443/svn/myapp/trunk/</connection><br /> <developerConnection>scm:svn:https://192.168.1.100:8443/svn/myapp/trunk/</developerConnection><br /> </scm><br /> [/xml]
        </p>
      </div>
    </div>
  </div>
  ...
  <div id="" class="dp-highlighter">
    <div class="bar">
      <div class="tools">
        <p>
          [xml]<br /> <plugin><br />  <groupId>org.apache.maven.plugins</groupId><br />   <artifactId>maven-release-plugin</artifactId>
        </p>
