...
<div>
  eclipse打开当前文件所在文件夹的插件<br /> Run&#8211;>External Tools&#8211;>External Tools Configurations&#8230;<br /> new 一个 program<br /> location 里面填 ：C:/WINDOWS/explorer.exe<br /> Arguments 里面填: ${container_loc}</p> 
