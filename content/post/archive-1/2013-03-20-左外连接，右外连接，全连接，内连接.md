...
SELECT a.au\_fname, a.au\_lname, p.pub_name
  
FROM authors a LEFT OUTER JOIN publishers p
  
ON a.city = p.city
  
ORDER BY p.pub\_name ASC, a.au\_lname ASC, a.au_fname ASC

下面是结果集：

au\_fname au\_lname pub_name
