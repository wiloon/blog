...
<div id="content">
 ...
 END CATCH
 <img alt="" src="http://www.cnblogs.com/Images/OutliningIndicators/None.gif" />注意上面脚本中函数的用法，我们可以用它们代替局部变量和（或者）全局变量。这些函数只应该被用在CATCH块中，函数功能说明如下：　　ERROR_NUMBER（） 返回错误数量。</p> 
