...
<pre><code class="language-java line-numbers">public class Person{
     private String name;
     private Home home;
...
<pre><code class="language-java line-numbers">public interface Contents {
int value();
}
...
<pre><code class="language-java line-numbers">public class Goods {
