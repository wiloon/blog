...
<pre><code class="language-bash line-numbers">parted -l
</code></pre>
...
<pre><code class="language-bash line-numbers">umount /dev/vdb
</code></pre>
...
<pre><code class="language-bash line-numbers">fuser -m /foo
...
<pre><code class="language-bash line-numbers">parted /dev/vdb
...
<pre><code class="language-bash line-numbers"> # 执行以下命令，检查磁盘分区文件系统的正确性,
e2fsck -f /dev/vdb
