...
<pre><code class="language-java line-numbers">module com.wiloon.java9x { }
</code></pre>

### 添加代码

<pre><code class="language-bash line-numbers">vim src/com.wiloon.java9x/com/wiloon/java9x/Java9Tester.java
</code></pre>

<pre><code class="language-java line-numbers">package com.wiloon.java9x;
...
<pre><code class="language-bash line-numbers">mkdir -p mods/com.wiloon.java9x
...
<pre><code class="language-bash line-numbers">java --module-path mods -m com.wiloon.java9x/com.wiloon.java9x.Java9Tester
</code></pre>