...
### java 模块
    mkdir -p  java-module-x/java-module-x/com/pingd/test/java/module/
    vim java-module-x/java-module-x/com/pingd/test/java/module/Hello.java
### Hello.java
...
### build
    cd java-module-x
    javac -d out/helloworld java-module-x/com/pingd/test/java/module/Hello.java java-module-x/module-info.java
...
### build  之后 out目录 结构
    └── out
        └── helloworld
            ...
            └── module-info.class
### 运行
    java --module-path ./out --module helloworld/com.pingd.test.java.module.Hello

### 打包成jar
    jar -cfe ./mods/helloworld.jar com.pingd.test.java.module.Hello -C out/helloworld .
