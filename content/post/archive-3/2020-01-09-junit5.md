...
JUnit 5 = JUnit Platform + JUnit Jupiter + JUnit Vintage
  ...
  1. JUnit Platform
    ...
    它还提供了一个控制台启动器，可以从命令行启动Platform，为Gradle和Maven插件提供支持。</p> 
  2. JUnit Jupiter
...
你可以在Maven或Gradle项目中使用JUnit5，包含最小的两个依赖关系，即junit-jupiter-engince和junit-platform-runner。<pre data-language=XML>

<code class="language-markup line-numbers">&lt;br />&lt;properties&gt;
...
<pre><code class="language-java line-numbers">import org.junit.jupiter.api.Test;
