...
## 本文链接：https://blog.csdn.net/pianzif/article/details/32106971
...
create index myindex on order\_mast(order\_id) local
...
create index glb\_ind on order\_mast(order_id) global
...
   create cluster emp\_dept\_cluster
...
   create index emp\_dept\_cluster_idx
  
　　on cluster emp\_dept\_cluster
...
　　cluster emp\_dept\_cluster(deptno)
...
        owner, object\_type, object\_name,

        constraint iot\_pk primary key(owner, object\_type,object_name)
...
  constraint heap\_stocks\_pk primary key (symbol,ticker_dt)
...
  constraint iot\_stocks\_pk primary key (symbol,ticker_dt)
...
   2    1     INDEX (RANGE SCAN) OF 'HEAP\_STOCKS\_PK' (UNIQUE)
...
   1    0   INDEX (RANGE SCAN) OF 'IOT\_STOCK\_PK' (UNIQUE) (Cost=2 Card=82 Bytes=2132)
...
    200    INDEX RANGE SCAN HEAP\_STOCKS\_PK (object id 30391)
...
    200   INDEX RANGE SCAN IOT\_STOCK\_PK (object id 30393)
