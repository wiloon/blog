...
<pre><code class="language-bash line-numbers"># jmxremote.rmi.port: 监听jmx客户端的端口
...
<pre><code class="language-bash line-numbers">jcmd &lt;PID&gt; ManagementAgent.stop
</code></pre>

### 通过JVM启动参数开启，需要重启JVM.

<pre><code class="language-bash line-numbers"># JVM command line option:
