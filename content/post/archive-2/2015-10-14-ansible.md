...
<div class="highlight">
  <pre>yum install ansible     # RHEL/CentOS/Fedora，需要配置 EPEL
...
<div class="highlight">
  <pre>ansible -i hosts all -m ping -u www
</pre>
</div>
...
<div class="highlight">
  <pre>ansible all -m raw -a 'yum -y install python-simplejson'
</pre>
</div>
...
<div class="highlight">
  <pre><span class="n">PLAY</span> <span class="p">[</span><span class="n">create</span>
