...
<pre><code class="language-bash line-numbers">ls *.js | xargs -t -n2 ls -al
...
<pre><code class="language-bash line-numbers">touch a.js b.js c.js d.js
</code></pre>

然后运行如下命令：

<pre><code class="language-bash line-numbers">ls -al a.js b.js
