...
func exec\_shell\_no_result(command string) {
      
//处理启动参数，通过空格分离 如：setsid /home/luojing/gotest/src/test\_main/iwatch/test/while\_little &
      
command\_name\_and\_args := strings.FieldsFunc(command, splite\_command)
