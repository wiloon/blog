...
[root@db1 oracle]# ls -l linux\_11gR2\_grid.zip
  
-rw-r&#8211;r- 1 oracle dba 980831749 Jul 11 20:18 linux\_11gR2\_grid.zip
...
cp linux\_11gR2\_grid.zip /dev/shm
...
This mount does not depend on CONFIG\_TMPFS. If CONFIG\_TMPFS is not
...
POSIX shared memory (shm\_open, shm\_unlink). Adding the following
...
This mount is \_not\_ needed for SYSV shared memory. The internal
...
nr\_blocks: The same as size, but in blocks of PAGECACHE\_SIZE.
