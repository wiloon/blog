...
<pre><code class="language-bash line-numbers">setup.template.name: "filebeat-"
...
<pre><code class="language-bash line-numbers">sudo rpm --import https://packages.elastic.co/GPG-KEY-elasticsearch
