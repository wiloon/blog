...
<pre><code class="language-bash line-numbers">tcpdump host 192.168.1.1
### 指定源地址
...
<pre><code class="language-bash line-numbers">sudo tcpdump port 9000
# 指定源端口
...
<pre><code class="language-bash line-numbers">tcpdump -i eth1 &lt;protocol name&gt;
# protocol name: arp, ip, tcp, udp, icmp
</code></pre>

<pre><code class="language-bash line-numbers"># -e Print the link-level header on each dump line
...
<blockquote class="wp-embedded-content" data-secret="zWlvvi8V4N">
  <p>
    <a href="https://coolshell.cn/articles/11564.html">TCP 的那些事儿（上）</a>
  </p>
</blockquote>

<iframe title="《TCP 的那些事儿（上）》—酷 壳 - CoolShell" class="wp-embedded-content" sandbox="allow-scripts" security="restricted" style="position: absolute; clip: rect(1px, 1px, 1px, 1px);" src="https://coolshell.cn/articles/11564.html/embed#?secret=zWlvvi8V4N" data-secret="zWlvvi8V4N" width="600" height="338" frameborder="0" marginwidth="0" marginheight="0" scrolling="no"></iframe>
