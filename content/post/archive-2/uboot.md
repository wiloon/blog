...
[https://www.jianshu.com/p/42106ed7cbde](https://www.jianshu.com/p/42106ed7cbde)
...
C 语言编译地址: 都希望把编译地址和实际运行地址放在一起的, 但是汇编代码因为不需要做c语言到汇编的转换, 可以认为的去写地址, 所以直接写的就是他的运行地址这就是为什么任何 bootloader 刚开始会有一段汇编代码, 因为起始代码编译地址和实际地址不相等, 这段代码和汇编无关, 跳转用的运行地址。\*\* \*\*
...
链接: [https://www.jianshu.com/p/42106ed7cbde](https://www.jianshu.com/p/42106ed7cbde)
