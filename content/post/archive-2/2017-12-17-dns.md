...
<iframe class="wp-embedded-content" sandbox="allow-scripts" security="restricted" style="position: absolute; clip: rect(1px, 1px, 1px, 1px);" src="http://blog.wiloon.com/?p=8698&embed=true#?secret=4F3Jvk9nTk" data-secret="4F3Jvk9nTk" width="600" height="338" title=""dnsmasq" - w1100n" frameborder="0" marginwidth="0" marginheight="0" scrolling="no"></iframe>