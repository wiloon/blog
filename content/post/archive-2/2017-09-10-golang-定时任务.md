...
author: wiloon
type: post
date: 2017-09-10T07:20:58+00:00
url: /?p=11156
categories:
  - Uncategorized
...
<pre><code class="language-go line-numbers">ticker := time.NewTicker(500 * time.Millisecond)
    go func() {
...
<pre><code class="language-go line-numbers"> d := time.Duration(time.Second*2)
