...
<pre><code class="language-java line-numbers">import java.lang.management.GarbageCollectorMXBean;
...
<blockquote class="wp-embedded-content" data-secret="w2JRHHSugP">
  <p>
    <a href="https://spin.atomicobject.com/2014/09/03/visualizing-garbage-collection-algorithms/">Visualizing Garbage Collection Algorithms</a>
  </p>
</blockquote>

<iframe title="&#8220;Visualizing Garbage Collection Algorithms&#8221; &#8212; Atomic Spin" class="wp-embedded-content" sandbox="allow-scripts" security="restricted" style="position: absolute; clip: rect(1px, 1px, 1px, 1px);" src="https://spin.atomicobject.com/2014/09/03/visualizing-garbage-collection-algorithms/embed/#?secret=w2JRHHSugP" data-secret="w2JRHHSugP" width="600" height="338" frameborder="0" marginwidth="0" marginheight="0" scrolling="no"></iframe>
