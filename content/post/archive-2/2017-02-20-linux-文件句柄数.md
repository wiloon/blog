...
<pre><code class="language-bash line-numbers">ulimit -a
# centos
# open files                      (-n) 65535
...
<pre><code class="language-bash line-numbers">cat /proc/&lt;PID&gt;/limits
</code></pre>
...
<pre><code class="language-bash line-numbers">lsof | wc -l
watch "lsof | wc -l"
...
<pre><code class="language-bash line-numbers">#设置当前shell的最大文件数, shell退出时失效.
ulimit -n 655360
ulimit -nS 2048
</code></pre>
...
<pre><code class="language-bash line-numbers">echo  6553560 &gt; /proc/sys/fs/file-max
...
<pre><code class="language-bash line-numbers"># 查看一个进程的limit设置：
cat /proc/PID/limits
...
<pre><code class="language-bash line-numbers">* soft nofile 65535
* hard nofile 65535
</code></pre>
