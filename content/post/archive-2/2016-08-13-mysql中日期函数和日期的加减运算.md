...
<code class="language-sql line-numbers">SELECT DATE('2017-02-11')
SELECT DATE('2017/02/11')
SELECT STR_TO_DATE('2015/02/25','%Y/%m/%d')
SELECT STR_TO_DATE('2015-02-25','%Y-%m-%d')
```

<code class="language-sql line-numbers">select count(*)/60 from xxx
...
<code class="language-sql line-numbers">select DATE_SUB(NOW(),INTERVAL  10 SECOND)
